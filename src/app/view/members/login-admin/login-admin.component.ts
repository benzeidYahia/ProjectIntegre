      ...
      public findUser() {
          ...
          this.service.findJury(this.login, this.password).subscribe(
                      data => {
                          ...
                          this.menu.layoutMode = 'slim';
                          this.model = [
                              {label: 'Clubs', icon: 'pi pi-fw pi-table', routerLink: ['pages/clubs']},
                              {label: 'Request', icon: 'pi pi-fw pi-plus', routerLink: ['pages/clubsRequest']},
                              {label: 'LogOut ', icon: 'pi pi-fw pi-sign-out', routerLink: ['/']},
                          ];
                          this.router.navigate(['pages/clubs']);
                      }, (errorResponse: HttpErrorResponse) => {
                  this.jury = null;
                  this.correct = false;
          ...
          this.service.findMember(this.login, this.password).subscribe(
              data => {
                  ...
                  this.model = [
                      ...
                      {label: 'Request', icon: 'pi pi-fw pi-plus', routerLink: ['pages/request']},
                      {label: 'LogOut ', icon: 'pi pi-fw pi-sign-out', routerLink: ['']}
                  ];
